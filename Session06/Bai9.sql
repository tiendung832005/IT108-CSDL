...
SELECT 
    ...
    d.FullName AS DoctorName, 
    a.AppointmentDate, 
    TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) AS Age,
    CASE 
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) < 18 THEN 'Trẻ em'
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) BETWEEN 18 AND 30 THEN 'Trung niên'
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) BETWEEN 31 AND 40 THEN 'Qua thời'
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) BETWEEN 41 AND 50 THEN 'Lớn tuổi'
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) BETWEEN 51 AND 60 THEN 'Già'
        WHEN TIMESTAMPDIFF(YEAR, p.DateOfBirth, a.AppointmentDate) > 60 THEN 'Người cao tuổi'
    END AS AgeGroup
FROM appointments a
